<template>
      ...
      <section class="about" id="about">
        <div class="container">
          ...
          <figure class="about-banner">
            <img src="../img/about-banner-1.png" alt="House interior">

            <img src="../img/about-banner-2.jpg" alt="House interior" class="abs-img">
          </figure>
          ...
          <ul class="service-list">
            ...
            <li>
              <div class="service-card">
                ...
                <div class="card-icon">
                  <img src="../img/service-2.png" alt="Service icon">
                </div>
    ...
    <footer class="footer">
        ...
        <div class="container">
            ...
            <a href="#" class="logo">
                <img src="../img/logo-light.png" alt="Homeverse logo">
            </a>
...
.card-badge.green { background: #282b39; }

.card-badge.orange { background: #ff5a3d; }
...
.header-top-link:is(:hover, :focus) { color: #ff5a3d; }
...
.navbar-link:is(:hover, :focus) { color: #ff5a3d; }
...
.header-bottom-actions-btn:is(:hover, :focus) ion-icon { color: #ff5a3d; }
...
.hero-subtitle ion-icon { color: #ff5a3d; }
...
.service-card {
  ...
  text-align: center;
  padding: 40px 30px;
  box-shadow: 0 16px 32px #071a1d1a;
}
...
.service-card .card-title > a:is(:hover, :focus) { color: #ff5a3d; }
...
.service-card:is(:hover, :focus) .card-link { color: #ff5a3d; }
...
.banner-actions-btn:is(:hover, :focus) { color: #ff5a3d; }
...
.property-card .card-title > a:is(:hover, :focus) { color: #ff5a3d; }
...
.author-name > a:is(:hover, :focus) { color: #ff5a3d; }
...
.features-card {
  ...
  align-items: center;
  gap: 10px;
  box-shadow: 0 5px 20px 0 #182d541a;
}

.features-card:is(:hover, :focus) { background: #ff5a3d; }
...
.features-card:is(:hover, :focus) .card-title { color: #ffffff; }
...
.features-card:is(:hover, :focus) .card-btn { color: #ff5a3d; }
...
.blog-card { box-shadow: 0 16px 32px #071a1d1a; }
...
.blog-card :is(.card-meta-link, .publish-date) ion-icon { color: #ff5a3d; }

.blog-card .card-meta-link:is(:hover, :focus) { color: #ff5a3d; }
...
.blog-card .blog-title:is(:hover, :focus) { color: #ff5a3d; }
...
.cta {
  background: linear-gradient(to bottom, #ffffff 50%, #181c2b 50%);
}
...
.cta-btn::before { background: #000000; }
...
.contact-link:is(:hover, :focus) span { color: #ff5a3d; }
...
.footer-link:is(:hover, :focus) { color: #ff5a3d; }
...
.copyright a:is(:hover, :focus) { color: #ff5a3d; }
